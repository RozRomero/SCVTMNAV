...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (document.querySelector('#search_menu')) {
    var hiddenOtherMenus = function hiddenOtherMenus(arrList) {
      var item = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
      // Ocultar todos los submenús menos el actual si se hace clic en el mismo elemento
      arrList.forEach(function (otherItem) {
        var arrowImg = otherItem.querySelector('#arrow_img');
        if (item) {
          if (otherItem !== item) {
          ...
          var _otherSubmenu = otherItem.nextElementSibling;
          _otherSubmenu.style.display = 'none';
          arrowImg.classList.remove('transform', '-rotate-90');
        }
      });
    };
    ...
    var searchMenu = document.querySelector('#search_menu');
    ...
    menuList.forEach(function (item) {
      item.addEventListener('click', function (event) {
        ...
        var arrowImg = item.querySelector('#arrow_img');
...
__webpack_require__(/*! /home/andres/public_html/TMGLOBAL/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/andres/public_html/TMGLOBAL/resources/css/app.css */"./resources/css/app.css");
